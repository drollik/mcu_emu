...
#define UCUNIT_WriteString(msg)    printf(msg)
/**
...
#define UCUNIT_WriteInt(n) 		printf("%i", n);
...
/**
 * @Macro:       UCUNIT_CheckIsTrue(value)
 * @Description: Checks if a value is true (1)
 * @Param value: Value to check.
 * @Remarks:     This macro uses UCUNIT_Check(condition, msg, args).
 */
#define UCUNIT_CheckIsTrue(value)   \
    UCUNIT_Check( ( (value) == 1 ), "IsTrue", #value)

/**
 * @Macro:       UCUNIT_CheckIsTrue(value)
 * @Description: Checks if a value is false (0)
 * @Param value: Value to check.
 * @Remarks:     This macro uses UCUNIT_Check(condition, msg, args).
 */
#define UCUNIT_CheckIsFalse(value)   \
    UCUNIT_Check( ( (value) == 0 ), "IsFalse", #value)
...
#define UCUNIT_TestcaseEnd()                                         \
    ...
    {                                                                \
        ...
        {                                                            \
			...
			UCUNIT_WriteString("Testcase failed.\n");                       \
